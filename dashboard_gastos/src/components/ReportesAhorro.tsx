...
export const ReportesAhorro = ({isMobile} : {isMobile: boolean}) => {
  ...
  return (
    ...
    (
      <div className=' flex flex-col mt-6 lg:mt-0 overflow-hidden'>
        <h1 className="text-lg lg:text-2xl text-center font-semibold mb-4">Aportes para meta de ahorro</h1>

        <section className='overflow-y-auto flex-1 lg:px-5 space-y-4'>
