        ...
        <form className="md:max-w-1/2 flex-1 ">
          <div className="flex ">
            ...
            <select 
              ...
              className="py-2  shrink-0 z-10 inline-flex items-center  px-3 text-sm font-medium text-center text-gray-900 bg-gray-200 border border-gray-300 rounded-s-3xl hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" 
            >
